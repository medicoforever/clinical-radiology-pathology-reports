...
- [Cervical Tubercular Lymphadenitis](reports/head_and_neck/cervical_tubercular_lymphadenitis.md) — *(3 case reports)*
- [Middle Ear Cholesteatoma](reports/head_and_neck/middle_ear_cholesteatoma.md) — *(3 case reports)*
- [Nasopharyngeal Carcinoma](reports/head_and_neck/nasopharyngeal_carcinoma.md) — *(3 case reports)*
- [Papillary Thyroid Carcinoma & TIRADS](reports/head_and_neck/papillary_thyroid_carcinoma_tirads.md) — *(3 case reports)*
- [Paranasal Fungal Sinusitis](reports/head_and_neck/paranasal_fungal_sinusitis.md) — *(3 case reports)*
...
- [Acute Ischemic Infarction (MCA)](reports/neuroimaging/acute_ischemic_infarction_mca.md) — *(3 case reports)*
- [Arteriovenous Malformation (AVM)](reports/neuroimaging/arteriovenous_malformation_avm.md) — *(3 case reports)*
- [Brain Abscess](reports/neuroimaging/brain_abscess.md) — *(3 case reports)*
- [Cavernous Malformation (Cavernoma)](reports/neuroimaging/cavernous_malformation_cavernoma.md) — *(3 case reports)*
- [Diffuse Axonal Injury (DAI)](reports/neuroimaging/diffuse_axonal_injury_dai.md) — *(3 case reports)*
- [Epidural Hematoma (EDH)](reports/neuroimaging/epidural_hematoma_edh.md) — *(3 case reports)*
- [Glioblastoma Multiforme](reports/neuroimaging/glioblastoma_multiforme.md) — *(3 case reports)*
- [Meningioma](reports/neuroimaging/meningioma.md) — *(3 case reports)*
- [Multiple Sclerosis Demyelination](reports/neuroimaging/multiple_sclerosis_demyelination.md) — *(3 case reports)*
- [Pituitary Macroadenoma](reports/neuroimaging/pituitary_macroadenoma.md) — *(3 case reports)*
- [Pontine / Brainstem Infarction](reports/neuroimaging/pontine_brainstem_infarction.md) — *(3 case reports)*
